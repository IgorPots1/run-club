...
type UseEntityCommentsControllerParams = {
...
export function useEntityCommentsController({
  ...
  useEffect(() => {
    ...
    return subscribeToEntityComments(entityType, entityId, {
      onInsert: (commentRow) => {
        void (async () => {
  ...
  }, [applyComments, entityId, entityType, resolveAuthorIdentity])
  ...
  useEffect(() => {
    ...
    return subscribeToEntityCommentLikes(entityType, entityId, {
      onInsert: (likeRow) => {
  ...
  }, [applyComments, currentUserId, entityId, entityType])
  ...
  const createComment = useCallback(
    async (comment: string, parentId: string | null = null) => {
      ...
      const createdComment = await createEntityComment(entityType, entityId, {
        comment,
        parentId,
      })
    ...
    [applyComments, currentUserId, entityId, entityType, onAuthRequired, rememberAuthorIdentity]
  )
