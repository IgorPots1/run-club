...
function WorkoutFeedCard({
  ...
  const hasCoverPhoto = Boolean(previewPhoto)
    ...
    >
      {previewPhoto ? (
        <button
          ...
          className="block overflow-hidden bg-[var(--surface-muted)] text-left"
      ...
      <div className={hasCoverPhoto ? 'px-5 pt-4' : ''}>
