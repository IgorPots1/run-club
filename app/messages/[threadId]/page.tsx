      ...
      <div className="mx-auto relative flex min-h-11 max-w-3xl items-center justify-between gap-3">
        <div className="pointer-events-auto shrink-0">
          <BackNavigationButton
            ...
            variant="icon"
            className="border-black/10 bg-[color:var(--surface)] shadow-none backdrop-blur-xl dark:border-white/12"
          />
        </div>
        <div className="pointer-events-none absolute inset-x-14 top-[calc(env(safe-area-inset-top)+1.625rem)] -translate-y-1/2">
          <div className="flex justify-center px-2">
            {isPlaceholder ? (
              <p
                className="app-text-primary inline-flex max-w-full items-center truncate rounded-full border border-black/10 bg-[color:var(--surface)] px-3 py-1 text-center text-[15px] font-medium text-transparent backdrop-blur-xl dark:border-white/12"
                aria-hidden="true"
              >
                &nbsp;
              </p>
            ) : (
              <p className="app-text-primary inline-flex max-w-full items-center truncate rounded-full border border-black/10 bg-[color:var(--surface)] px-3 py-1 text-center text-[15px] font-medium backdrop-blur-xl dark:border-white/12">
                {title}
              </p>
            )}
          </div>
  ...
  const headerRightSlot = threadId ? (
    <div ref={headerMenuRef} className="relative">
      <button
        ...
        className="app-text-primary inline-flex h-8 w-8 items-center justify-center rounded-full border border-black/10 bg-[color:var(--surface)] text-[16px] leading-none shadow-none backdrop-blur-xl disabled:cursor-not-allowed disabled:opacity-60 dark:border-white/12"
